...
namespace SchoolProSite.Web.Controllers
{
    public class CourseController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            var departmentLis = this.daoDepartment.GetDepartments()
                                                            .Select(cd => new Models.DepartmentList()
                                                            {
            ...
            ViewData["Deparments"] = new SelectList(this.daoDepartment.GetDepartments(), "DepartmentId", "Name");
